;tine20drive installer script.

!define APPLICATION_SHORTNAME "@APPLICATION_EXECUTABLE@"
!define APPLICATION_NAME "@APPLICATION_NAME@"
!define APPLICATION_BASE "@APPLICATION_BASE@"
...
Section "${APPLICATION_NAME}" SEC_APPLICATION
   ...
   File "${BUILD_PATH}\bin\lib${APPLICATION_BASE}sync.dll"
   File "${BUILD_PATH}\bin\lib${APPLICATION_BASE}_csync.dll"
